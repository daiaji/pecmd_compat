...
# Find the generated ISO (converter creates it in the current working directory)
BASE_ISO=$(find . "$UUP_FILES_DIR" "$WORK_DIR" -maxdepth 1 -name "*.iso" -type f 2>/dev/null | head -1)
